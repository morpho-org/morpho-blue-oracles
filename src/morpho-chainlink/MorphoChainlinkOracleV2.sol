...
contract MorphoChainlinkOracleV2 is IMorphoChainlinkOracleV2 {
    ...
    /// assets has enough precision.
    /// @dev Morpho Blue markets have issue when the price of the oracle can go up instantly by a multiplier of more
    /// than 1/(LLTV*LIF). So in particular, vaults that can receive donations as loan/quote assets are problematic.
